    ...
    public void onChat(ClientChatReceivedEvent e){
        ...
        if(GameData.tellraw){
            ...
            try{
                ...
                Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Not Hypixel Says"));
                GameData.reset();
            }

           if(mode.equalsIgnoreCase("\"santa_says\"")||mode.equalsIgnoreCase("\"hypixel_says\"")){
               GameData.inHypixelSays=true;
               Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Joined Hypixel Says"));
               GameData.reset();
           }else{
               GameData.inHypixelSays=false;
               Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("Not Hypixel Says"));
        ...
        }else if(GameData.inHypixelSays && message.toLowerCase().contains("next task")){
            GameData.round++;
            ...
            if(possiblePoints+GameData.secondPlaceScore<GameData.score){
                ...
                Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("You were automatically requeued"));
            }
        }
    }
